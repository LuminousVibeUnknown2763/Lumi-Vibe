...
const boutIcon = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" style="width: 28px; height: 24px; flex-shrink: 0;">
...
abouta.innerHTML = boutIcon + 'About';
checkListAnchor.innerHTML = checkListIcon + 'Projects';
